...
anirudh_image = face_recognition.load_image_file("Anirudh/anirudh.jpeg")
...
# Load a second sample picture and learn how to recognize it.
himendra_image = face_recognition.load_image_file("himendra/himendra.png")
himendra_face_encoding = face_recognition.face_encodings(himendra_image)[0]

# Load a sample picture and learn how to recognize it.
inderkant_image = face_recognition.load_image_file("inderkant/inderkant.png")
inderkant_face_encoding = face_recognition.face_encodings(inderkant_image)[0]
